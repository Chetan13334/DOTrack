        ...
        <div className="p-6 flex flex-col gap-6">
          <div className="space-y-3">
            <div className="flex flex-col gap-1">
              ...
              <p className="text-sm text-white font-medium bg-white/5 p-3 rounded-lg border border-white/5">
                {template.title}
              </p>
            </div>
            
            <div className="flex flex-col gap-1">
              <span className="text-[10px] uppercase tracking-widest text-white/40 font-bold">Pipeline Hash (IPFS)</span>
          ...
          <div className="bg-white/5 p-4 rounded-xl border border-white/5">
            <div className="flex items-center gap-3 mb-1">
              ...
              <span className="text-[10px] uppercase tracking-widest text-white/40 font-bold">On-Chain Action</span>
            </div>
          ...
          <div className="flex justify-between items-center px-1">
            <div className="flex flex-col">
              <span className="text-[10px] uppercase tracking-widest text-white/40 font-bold">Estimated Gas Fee</span>
              <div className="flex items-baseline gap-2">
                <span className="text-sm font-bold text-white">0.0032 ETH</span>
                <span className="text-xs text-white/40">($7.42 USD)</span>
              </div>
            </div>
            <div className="text-green-500 flex items-center gap-1 text-[10px] font-bold uppercase tracking-tight">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button 
              className="flex-1 py-3 px-4 rounded-xl bg-primary hover:bg-primary/90 text-white font-bold text-sm flex items-center justify-center gap-2 transition-all shadow-lg shadow-primary/20"
              onClick={onConfirm}
            >
